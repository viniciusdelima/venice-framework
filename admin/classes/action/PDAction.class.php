<?php
PDAutoload::load('ActionNotFoundException', 'action.exceptions');
PDAutoload::load('ModuleNotFoundException', 'action.exceptions');
PDAutoload::load('ViewNotFoundException', 'view.exceptions');
PDAutoload::load('ConfigureHelper', 'action.helpers');
...
abstract class PDAction {
	...
	public function __construct() {
		...
		foreach ($this->helpers as $helper) {
			PDAutoload::load($helper . 'Helper', 'view.helpers');
		}
	}
