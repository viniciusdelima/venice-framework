<div class="span9">
	...
	<div class="span6">
		...
		<form action="<?php echo HtmlHelper::createsValidURL('FAQ', 'add'); ?>" method="post" class="form-horizontal">
				...
				<table class="table table-bordered">
					<tbody>
						<?php foreach ($faq as $entrie) : ?>
							<tr>
								<td><?php HtmlHelper::link('faq', 'remove', '<i class="icon-remove"></i>', array('class' => 'btn'), array($entrie['asking_id'])); ?> <?php echo $entrie['asking_text']; ?></td>
							</tr>
						<?php endforeach; ?>
					</tbody>
				</table>
