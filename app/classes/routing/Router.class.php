...
if ( !defined('ABSPATH')) { define('APP_DIR', dirname( dirname( dirname(__FILE__)))); }
...
class Router {
	...
	public static function getPathView() {
		defined('APP_DIR') ? $path = APP_DIR . DS . 'template' : $path = dirname( dirname( dirname(__FILE__))) . DIRECTORY_SEPARATOR . 'template';
		return $path; 
	}
