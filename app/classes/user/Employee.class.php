 ...
 * Esta classe herda a classe base User e têm por objetivo representar um funcionário que irá usar o sistema.
 * 
 * @author Pi Digital
 * @abstract User
 * @package user
 */
class Employee extends User implements AdministratorInterface, FormInterface {
