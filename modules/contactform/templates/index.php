<div class="span9">
	...
	<div class="span6 add-register-form">
		<form class="form-horizontal" style="margin-top: 20px;" action="<?php echo HtmlHelper::createsValidURL('contactform', 'add'); ?>" method="post">
							...
							<tr>
								...
								<td><?php 
										if ($field['field_active'] == 1) { 
											HtmlHelper::link('contactform', 'update', '<i class="icon-ban-circle"></i>', null, array('id' => $field['field_id'], 'visibility' => $visibility)); 
										}
										else {
											HtmlHelper::link('contactform', 'update', '<i class="icon-ok"></i>', null, array('id' => $field['field_id'], 'visibility' => $visibility));
										}	
									?></td>
							</tr>
					<?php endforeach; ?>
